...
#define rb_for_cx_m(cx, tree, elem, code) \
    rb_for_tr_m( \
        cx##_type_t, \
        cx##_parent_m, \
        cx##_left_m, \
...
#define rb_for_m(cx, tree, elem, code) \
    rb_for_tr_m( \
        cx##_type_t, \
        rb_parent_m, \
        rb_left_m, \
...
// .. code-block:: cpp
//
#define rb_iter_decl_tr_m(type, elem) \
    type* elem = NULL; \
...
#define rb_iter_decl_m(cx, iter, elem) \
    cx##_type_t* elem = NULL; \
...
// .. code-block:: cpp
//
#define rb_iter_init_tr_m(tree, elem) \
    elem = tree; \


#define rb_iter_init_cx_m(cx, tree, iter, elem) \
    elem = tree; \


#define rb_iter_init_m(cx, tree, iter, elem) \
    elem = tree; \
...
#define rb_iter_next_cx_m(cx, iter, elem) \
    rb_iter_next_tr_m( \
        cx##_type_t, \
        cx##_parent_m, \
        cx##_left_m, \
...
#define rb_iter_next_m(cx, iter, elem) \
    rb_iter_next_tr_m( \
        cx##_type_t, \
        rb_parent_m, \
        rb_left_m, \
...
// .. code-block:: cpp
//
#define rb_iter_end_tr_m(elem) \
    (elem == NULL) \


#define rb_iter_end_cx_m(cx, iter, elem) \
    (elem == NULL) \


#define rb_iter_end_m(cx, iter, elem) \
    (elem == NULL) \
...
#define rb_check_tree_cx_m(cx, tree, result) \
    rb_check_tree_tr_m( \
        cx##_type_t, \
        cx##_color_m, \
        cx##_parent_m, \
...
#define rb_check_tree_m(cx, tree, result) \
    rb_check_tree_tr_m( \
        cx##_type_t, \
        rb_color_m, \
        rb_parent_m, \
